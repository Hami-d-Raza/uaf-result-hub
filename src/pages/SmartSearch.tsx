...
import { Search, Download, Filter, BookOpen, XCircle, Info, Upload, ArrowRightLeft, Users } from "lucide-react";
                    ...
                    <AnimatePresence>
                        {loading && hasSearched && results.length === 0 && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, x: 20 }}
                                className="flex-1 flex flex-col h-full overflow-hidden bg-muted/5 rounded-xl border p-4"
                            >
                                <div className="mb-3">
                                ...
                                <div className="space-y-3 overflow-auto">
                                    {[1, 2, 3, 4, 5].map((i) => (
                                        <SearchResultCardSkeleton key={i} index={i - 1} />
                                    ))}
                                </div>
                            </motion.div>
                        )}
                                            ...
                                            {Object.entries(stats).map(([grade, count]) => (
                                                <div
                                                    ...
                                                    className={cn(
                                                        ...
                                                        grade === 'A' ? "bg-amber-500/10 border-amber-500/20 hover:bg-amber-500/20" :
                                                ...
                                                <CardContent className="p-0">
                                                    <Table>
                                                        ...
                                                        <TableBody>
                                                            ...
                                                            {loading && [1, 2, 3].map(i => (
                                                                <SmartSearchRowSkeleton key={`skel-sm-${i}`} />
                                                            ))}
                                                        </TableBody>
                                                    </Table>
                                                </CardContent>
