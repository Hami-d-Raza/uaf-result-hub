...
const features = [
  ...
  },
  {
    ...
    description: "Calculate the GPA required each semester to reach your target CGPA",
              ...
              {[
                {
                  ...
                  description: "Input your UAF registration number (e.g., 2022-ag-7688) to fetch your official academic records instantly.",
                },
                {
                  step: "02",
                  icon: ChartColumn,
                ...
                <motion.div
                  ...
                  className="bg-card rounded-2xl border border-border p-6 hover:shadow-lg transition-all duration-300 group hover:border-primary"
                >
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className="text-4xl font-bold text-primary transition-colors"
                    >
                      {item.step}
                    </span>
