...
import { Search, Download, Upload, Users, XCircle, ArrowRightLeft, ArrowUpDown } from "lucide-react";
                    ...
                    <Table>
                      ...
                      <TableBody>
                        ...
                        {loading && [1, 2, 3, 4, 5].map(i => (
                          <ClassResultRowSkeleton key={`skel-cr-${i}`} />
                        ))}
                      </TableBody>
                    </Table>
                  </div>
